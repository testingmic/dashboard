...
<div class="space-y-8">
    ...
    <div class="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-8 text-white shadow-2xl">
        <div class="absolute inset-0 bg-gradient-to-br from-pink-500/20 via-purple-500/20 to-blue-500/20"></div>
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold mb-2 bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-white">Dashboard Overview</h2>
                    <p class="text-gray-100 text-lg">Monitor your delivery platform performance in real-time</p>
                </div>
            </div>
        </div>
        <!-- Decorative elements -->
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Total Orders Today -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-blue-200 to-blue-100 rounded-2xl p-6 text-black shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 backdrop-blur-sm border border-white/10">
            <div class="relative z-10">
                ...
                <p class="text-dark text-sm font-medium mb-1">Orders Today</p>
                <p class="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-black"><?= number_format($kpis['orders_today']) ?></p>
        ...
        <!-- Active Users -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-green-200 to-green-100 rounded-2xl p-6 text-black shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 backdrop-blur-sm border border-white/10">
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-dark text-sm font-medium mb-1">Active Users</p>
                <p class="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-pink-100 bg-clip-text text-black"><?= number_format($kpis['active_users']) ?></p>
                <p class="text-xs text-dark">
        ...
        <!-- Active Riders -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-pink-200 to-pink-50 rounded-2xl p-6 text-black shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 backdrop-blur-sm border border-white/10">
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-dark text-sm font-medium mb-1">Online Riders</p>
                <p class="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-purple-100 bg-clip-text text-black" id="online-riders-count"><?= number_format($kpis['active_riders']) ?></p>
                <p class="text-xs text-dark">
        ...
        <!-- Total Revenue -->
        <div class="group relative overflow-hidden bg-gradient-to-br from-yellow-200 to-red-50 rounded-2xl p-6 text-black shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105 backdrop-blur-sm border border-white/10">
            <div class="relative z-10">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-xl flex items-center justify-center backdrop-blur-sm shadow-lg">
                ...
                <p class="text-dark text-sm font-medium mb-1">Total Revenue</p>
                <p class="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-yellow-100 bg-clip-text text-black">$<?= number_format($kpis['total_revenue']) ?></p>
                <p class="text-xs text-dark">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex items-center space-x-2">
                    <select id="revenue-period" class="text-sm border border-white/20 rounded-xl px-4 py-2">
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between mb-8">
                ...
                <div class="flex items-center space-x-2">
                    <span class="text-sm text-gray-600 bg-gradient-to-r from-pink-500/20 to-purple-500/20 px-3 py-1 rounded-full border border-white/10">Total: <?= number_format($kpis['orders_today'] + $kpis['orders_in_progress'] + $kpis['orders_completed']) ?></span>
                </div>
            </div>
            <div class="h-80">
