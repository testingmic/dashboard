 ...
 * @return bool
 */
function is_driver($currentUser) {
    return (bool) !empty($currentUser['isDriver']);
}
 ...
 * @return bool
 */
function is_admin_or_driver($currentUser) {
    return is_admin($currentUser) || is_driver($currentUser);
}
